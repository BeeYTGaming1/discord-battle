                ...
                if (msg.content.toLowerCase() === attacks[i]) {
                    ...
                    if (chance[attackChance] === "yes") {
                        ...
                        await channel.send(
                            new MessageEmbed()
                                .setDescription(
                                    `${nowBattling} sử dụng **${attacks[i]}** against ${nextUp}, nhưng không thành công!, bây giờ họ có \`${playerTwoData.battleHealth}\` HP`
                                )
                                .setColor("RED")
                                .setAuthor(
                                    `Đánh bởi: ${nowBattling.displayName}`,
                ...
                if (msg.content.toLowerCase() === attacks[i]) {
                    ...
                    if (chance[attackChance] === "yes") {
                        ...
                        await channel.send(
                            new MessageEmbed()
                                .setDescription(
                                    `${nowBattling} sử dụng **${attacks[i]}** làm \`${attackAmount}\` thiệt hại cho ${nextUp}, bây giờ họ có \`${playerOneData.battleHealth}\` HP`
                                )
                                .setColor("RED")
                                .setAuthor(
                                    `Đánh bởi: ${nowBattling.displayName}`,
                ...
                if (msg.content.toLowerCase() === heals[x]) {
                    ...
                    if (chance[healChance] === "yes") {
                        ...
                        await channel.send(
                            new MessageEmbed()
                                .setDescription(
                                    `${nowBattling} sử dụng **${heals[x]}** và chữa lành \`${healAmount}\` HP, bây giờ họ có \`${playerTwoData.battleHealth}\` HP!`
                                )
                                .setColor("GREEN")
                                .setAuthor(
                                    `Hồi máu bởi: ${nowBattling.displayName}`,
        ...
        setTimeout(() => {
            return channel.send(
                new MessageEmbed()
                    ...
                    .setDescription(
                        `${won} has won the battle with \`${wonData.battleHealth}\` HP`
                    )
                    .setColor("GREEN")
